...
3. `Available portable skills`: list `agent-attention`, `hello-world`, `skill-a`, `skill-b`, `runtime-custody`, and `capability-tour`, marking the first four Bun-backed and the last two model-only.
